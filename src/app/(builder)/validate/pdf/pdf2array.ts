...
/**
 * This file is based on Tony Roberts' pdf2array, which is distributed under MIT License.
 * 
 * You can find the original source at https://github.com/tonyroberts/pdf2array
 * 
 */
 ...
 * @param options
 */
export async function arrayFromPdf(data: ArrayBuffer, options?: Pdf2ArrayOptions): Promise<string[][]> {
